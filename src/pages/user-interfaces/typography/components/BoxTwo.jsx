...
export class BoxTwo extends Component {
    render() {
        return (
            <React.Fragment>
                <div className="col-md-6">
                    <div className="card">
                        <div className='card-header'>
                            <div className="card-title">Heading Weight</div>
                        </div>
                        <div className='card-body'>
                            <div className="card-text mgb-15">
                            Available to use light and bold font-weight. Use <code>.text-lighter</code> for light heading 
                            and <code>.text-bold</code> for bold headings along with heading tags or classes. And use <code>text-w-*</code> for using text with number.
                            </div>
